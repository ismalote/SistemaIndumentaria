...
CREATE TABLE MATERIAL (
    codigoMaterial int NOT NULL IDENTITY (1,1),
...
-- Table: PRENDA
CREATE TABLE PRENDA (
    codigoPrenda int NOT NULL IDENTITY (1,1),
...
CREATE TABLE TEMPORADA (
    codigoTemporada int NOT NULL IDENTITY (1,1),
...
-- Table: VENTA
CREATE TABLE VENTA (
    nroVenta int NOT NULL IDENTITY (1,1),
